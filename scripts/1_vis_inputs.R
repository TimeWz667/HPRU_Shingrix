...
g
ggsave(g, filename = folder_outputs("Inputs_Pop_IC_Ons_2015.png"), width = 6, height = 4)
...
g
ggsave(g, filename = folder_outputs("Inputs_Pop_NIC_Ons_2015.png"), width = 6, height = 4)
...
g
ggsave(g, filename = folder_outputs("Inputs_DeathBg_NIC_Ons_2015.png"), width = 6, height = 4)
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_Incidence_HZ_All_IC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_Incidence_HZ_GP_IC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_Mortality_HZ_IC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_P_PHN_IC_CPRD.png"), width = 6, height = 4)
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_Incidence_HZ_All_NIC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_Incidence_HZ_GP_NIC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_Mortality_HZ_NIC_CPRD.png"), width = 6, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_P_PHN_NIC_CPRD.png"), width = 6, height = 4)
...
local({
  ...
  g <- Rate_Hospitalisation_HZ %>% 
    filter(Key <= N_Iter) %>% 
    filter(age >= 18) %>% 
    ggplot(aes(x = age, y = Hospitalisation_rate_HZ)) +
    stat_lineribbon(.width = c(.99, .95, .8, .5), color = "#08519C") +
  ...
  ggsave(g, filename = folder_outputs("Inputs_Hospitalisation_HZ_IC_CPRD.png"), width = 6, height = 4)
})
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_Hospitalisation_HZ_NIC_CPRD.png"), width = 6, height = 4)
})
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_VE_IC.png"), width = 8, height = 4)
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_VE_NIC.png"), width = 8, height = 4)
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_QL_yr1.png"), width = 8, height = 4)
  ...
  ggsave(g, filename = folder_outputs("Inputs_QL_yr2.png"), width = 8, height = 4)
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_Cost_hospitalisation_IC.png"), width = 8, height = 4)
})
...
local({
  ...
  ggsave(g, filename = folder_outputs("Inputs_Cost_hospitalisation_NIC.png"), width = 8, height = 4)
})
