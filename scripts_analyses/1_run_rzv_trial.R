...
# Load inputs
load(file = here::here("pars", "parset_nic_c35q35y24n1k_tr.rdata"))
...
save(yss, file = here::here("out", "yss_rzv_tr.rdata"))
...
write_csv(stats_ys, file = here::here("docs", "tabs", "stats_ys_rzv_tr.csv"))
...
write_csv(stats_ce, file = here::here("docs", "tabs", "stats_ce_rzv_tr.csv"))
