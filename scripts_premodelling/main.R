...
source(here::here("scripts", "1_vis_inputs.R"))

## Parameters: Demography

source(here::here("scripts", "2_1_prepare_pars_demo.R"))


## Parameters: Epidemiology
source(here::here("scripts", "2_2_model_epi_gpr.R"))


## Parameters: Costing
source(here::here("scripts", "2_3_prepare_pars_cost.R"))
...
source(here::here("scripts", "3_3_fit_ve_zvl_zi_stan.R"))
source(here::here("scripts", "3_4_compile_ve.R"))
source(here::here("scripts", "3_5_fit_ve_rzv_sens.R"))
