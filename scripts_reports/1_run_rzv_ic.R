...
for (ve_type in c("trial", "realworld")) {
  ...
  # Load inputs
  load(file = here::here("pars", "parset_ic_c35q35y24n1k_" + ve_type + ".rdata"))
  ...
  save(yss, file = here::here("out", "yss_rzv_ic_" + ve_type + ".rdata"))
...
for (ve_type in c("trial", "realworld")) {
  ...
  write_csv(stats_ce, file = here::here("docs", "tabs", "stats_ce_rzv_ic_" + ve_type + ".csv"))
  ...
  write_csv(stats_icer, file = here::here("docs", "tabs", "stats_icer_rzv_ic_" + ve_type + ".csv"))
}
